...
class TiledKSampler:
    ...
    FUNCTION = "tiled_sampler"
    OUTPUT_NODE = True


    def tiled_sampler(self, config_pipe_enabled, model, vae, seed, steps, cfg, sampler_name, scheduler, positive, negative, image, control_net, tile_resolution, tile_overlap, denoise=0.5, strength=0.5, config_pipe_in=None, post_process_enable=False, desaturate=0.2, sharpen=0.8):          
